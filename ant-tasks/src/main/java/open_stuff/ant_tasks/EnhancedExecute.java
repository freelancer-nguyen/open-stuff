...
public class EnhancedExecute extends Execute {
	...
	public EnhancedExecute() {
		super();
	}

	public EnhancedExecute(ExecuteStreamHandler streamHandler,
	...
	private static int getPid(Process p) {
		...
		if (Platform.isWindows()) {
			...
			try {
				...
				f.setAccessible(true);
				int pid = ((Integer)f.get(p)).intValue();
				return pid;
			} catch (Exception ex) {
				ex.printStackTrace();
			}
